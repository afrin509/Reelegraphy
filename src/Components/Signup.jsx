    ...
    return (
        <div className={classes.centerDivs}>
            <Container>
                ...
                <Grid item display={{ xs: 'none' }} sm={4} >
                    ...
                    <Grid item xs={12} sm={5}>
                        <Card variant="outlined">
                            ...
                            />
                            <CardContent>
                            <Typography style={{textAlign:'center', color:'darkgray'}} variant="subtitle2">Signup to see photos and videos from friends</Typography>
                            </CardContent>
                            <CardContent className={classes.centerElements}>
                            <TextField id="outlined-basic" label="Username" type="text" variant="outlined" value={username} size="small" display="block"
                            ...
                            <Button
                                    ...
                                    >
                                    <Typography style={{color:'red'}}>UPLOAD PROFILE IMAGE</Typography>
                                    <input
                                        type="file" accept="image/*" onChange={(e) => { handlFileSubmit(e) }}
                                        hidden
                                    />
                                </Button>
                            </CardActions>
                            <CardActions>
                                <Button variant="contained" display="block" style={{backgroundColor:'#0095f6',color:'white'}} onClick={handleSignup} disabled={loader} className={classes.Width80}>SignUp</Button>
                            </CardActions>
                            <CardContent>
                            <Typography style={{textAlign:'center'}} variant="subtitle1">By signing up, you agree to our Terms, Data Policy and Cookies Policy</Typography>
                            </CardContent>
                        </Card>
                        <Card variant="outlined" >
